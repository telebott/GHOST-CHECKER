...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '<font color=red><b>DEAD [ '.GetStr($result2,'"message": "','"').' ]<span style="color: rgb(0 255 0);  font-weight: bold"> [Re: ' . $x . ']</span><br><span style="color: #ff4747;  font-weight: bold; margin-bottom:3px;">'.$lista.'</span><br>';
}
